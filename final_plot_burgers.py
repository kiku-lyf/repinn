...
每个子图独立颜色条，与 NS/Allen-Cahn/KdV 代码保持完全一致
"""
...
def load_burgers_data(data_path):
    """加载 Burgers 方程的真实解数据"""
...
def main():
    ...
    try:
        Exact, XX_ref, TT_ref, x_star, t_star = load_burgers_data(args.data_path)
